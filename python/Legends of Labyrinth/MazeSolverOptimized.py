...
# explorer_list = [['Left', 'Right'], ['Left'], ['Left', 'Straight'], ['Right'], ['Left']]
...
def populate_explorer_list(filename):
...
explorer_list = populate_explorer_list("path")
...
def act():
    ...
    current_compound_decision = explorer_list[0]
    ...
    if decision == "straight":
        ...
        is_compound_movement = True
        perform_movement(current_compound_decision[-1])
    elif decision == "leftstraight":
        is_compound_movement = True
        perform_movement(current_compound_decision[-1])
    elif decision == "rightstraight":
    ...
    if is_compound_movement == True:
      print("Compound decision is: ", current_compound_decision[-1])
      explorer_list.pop(0)
